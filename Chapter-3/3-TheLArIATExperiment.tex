...
Inside the LArIAT experimental hall, the cryostat sits on the beam of charged particles with its horizontal main axis oriented parallel to the beam.
...
mounted on the TPC frame inside the liquid argon, achieving a remarkable Signal-to-Noise ratio. %The BNL ASICs adopted in LAriAT are designated as LArASIC, version 4-star.%The ASIC signals for each wire are then driven out of the vessel  to DAQ boards that act as waveform recorders.
