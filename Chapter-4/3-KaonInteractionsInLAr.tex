...
The number of secondary pions is given in the MC by the number of matched WC2TPC tracks which are not flagged as primary by Geant4.
...
The second step for handling the contamination is subtracting it from data.
