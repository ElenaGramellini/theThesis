\chapter{Total Ha($\pi^{-}$,Ar)dronic Cross Section Measurement Methodology}\label{ch:Interactions}
...
\subsubsection{TPC Selection: Halo mitigation }\label{ch:pileUp}
...
Still using the pion case as example, we estimate the pion cross section in each energy bin changing  the equation \ref{eq:thinTargetXSSolved2} into
\begin{equation}
