...
This chapter describes the general procedure employed to measure  total hadronic interaction cross sections on argon in LArIAT.
...
\put(-310,180){\bf\tiny{LArIAT Preliminary}}
\put(-92,180){\bf\tiny{LArIAT Preliminary}}
...
\end{minipage}
\put(-420,30){\bf\tiny{LArIAT Preliminary}}
\put(-192,30){\bf\tiny{LArIAT Preliminary}}
