...
%The read-out of a LArIAT event is triggerred by a CAEN V1495 module.
...
%Scope of the LArIAT DAQ and trigger system is to start the read out of the detector, to convert signals from analog to digital, to interface and synchronize with the accelerator system, to store raw data on disk, transfer data to archival storage and conduct a first pass data quality monitoring. 


%A CAEN V1495 governs LArIAT DAQ system. 

%The system is made by commercial VME electronics from CAEN, a VME time to digital converter for the beamline time of flight system, and a readout system for beamline wire chambers.
