...
A summary of the pion final states in order of pion multiplicity is given in table 

%\ref{tab:pionFinal}
\Rotatebox{90}{%
\begin{tabular}{llll}
\hline
N $\pi$ in final state & Channel Name & Channel description & Reaction \\
\hline
                       &              &                     &          \\
                       &              &                     &          \\
                       &              &                     &          \\
...
Pion capture on the argon orbital and pion decay at rest dominate the cross section under 100 MeV/c. Since pion capture can be considered an electromagnetic process and pion decay is a weak process, this energy region is purposely excluded from the hadronic cross section measurement.
