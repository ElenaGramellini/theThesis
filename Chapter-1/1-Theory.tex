...
\begin{tabular}{|l|l|}
\hline
$\Delta$ (1232) 3/2$^+$                 & $N^*$ (1440) 1/2$^+$    \\ \hline
$\Delta^{++} \text{(uuu)} \rightarrow p \pi^+$ & $N^* \rightarrow N \pi$ \\
$\Delta^{+} \text{(uud)} \rightarrow n \pi^+$  &  $N^* \rightarrow N \pi\pi$\\ 
$\Delta^{+} \text{(uud)} \rightarrow p \pi^0$  &                         \\ 
$\Delta^{0} \text{(udd)} \rightarrow n \pi^0$  &                         \\ 
$\Delta^{0} \text{(udd)} \rightarrow p \pi^-$  &                         \\ 
$\Delta^{-} \text{(ddd)} \rightarrow n \pi^-$  &                         \\ \hline
\end{tabular}
