...
\item[-] \textcolor{red}{something about GUTs}.
\end{itemize}
...
The strong force determines most of the interactions between an argon nucleus and a charged pion in the [100 -1200] MeV energy range. The total hadronic $\pi^{-}$-Ar interaction cross section is defined as the one related to the single (hadronic) process driven only by the strong interaction. In measuring the ``total" cross section, we include both the elastic and  reaction channels, regardless of the final state, 
\begin{equation}
...
A summary of the pion final states in order of pion multiplicity is given in table \ref{tab:pionFinal}. Pion capture on the argon orbital and pion decay at rest dominate the cross section under 100 MeV. Since pion capture can be considered an electromagnetic process and pion decay is a weak process, this energy region is purposely excluded from the hadronic cross section measurement.
