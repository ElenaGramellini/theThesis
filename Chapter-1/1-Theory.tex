...
\hline
 ...
 1 &  \textbf{Charge Exchange}, $\sigma_{chex}$ & \begin{tabular}{@{}l@{}} $\pi^- + p \rightarrow \Delta^0 \rightarrow \pi^0+n$ \\ $\pi^- + N \rightarrow \pi^+ + $ nucleons  \end{tabular} &\begin{tabular}{@{}m{8cm}@{}}Single charge exchange: charged pion converts into neutral pion \\  \\Double charge exchange: charged pion converts into opposite charge pion  \end{tabular}   \\
  ...
  \hline
                      &              &                     &           \\
 2+ & \textbf{Pion Production}, $\sigma_{\pi prod}$    &           $\pi^- + N \rightarrow \ge2 \pi $ + nucleons            &  Possible if pion K.E $\ge$ 500 MeV       \\
                    &              &                     &           \\
\hline
\end{tabular}
%}
\caption{Summary of negative pion hadronic interactions of the reaction channel as a function of the pion multiplicity in the final state for the energy range [100-1200] MeV. }
\label{tab:pionFinal}
\end{sidewaystable}
