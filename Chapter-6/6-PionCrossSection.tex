...
We use the procedure described in \ref{ch:PionXSBkgSub2} to evaluate the pion content in the interacting $C^{\pi MC}_{\text{Int}} (E_{i})$  and incident $C^{\pi MC}_{\text{Inc}} (E_{i})$) histograms.
